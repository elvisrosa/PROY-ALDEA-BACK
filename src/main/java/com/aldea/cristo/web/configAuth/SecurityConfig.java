    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz)
                        ...
                        .requestMatchers("/api/niños/listarporcasa/**").permitAll()
                        .requestMatchers("/api/casa/actualizar/**").permitAll()
                        .requestMatchers("/api/casa/cambiarestado/**").permitAll()
                        //.requestMatchers("/api/eliminar/**").hasAnyRole("ADMIN", "ADMINT")
                        .requestMatchers("/api/eliminar/**").permitAll()
                        //.requestMatchers("/api/user/**").hasRole("ADMINT")
                        .requestMatchers("/api/user/**").permitAll()
                        .requestMatchers(HttpMethod.PATCH, "/api/user/actualizar/**").permitAll()
