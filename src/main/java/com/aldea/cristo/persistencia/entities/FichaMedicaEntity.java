...
public class FichaMedicaEntity 
{
  @Id
    ...
    public FichaMedicaEntity(Integer idFichaMedica, LocalDate fecha, String estatura, float peso, String descripcionDiagnostico, String descripcionTratamiento, String medicamentos, String nombreDoctor, String tipoSangre, NinoEntity nino) {
